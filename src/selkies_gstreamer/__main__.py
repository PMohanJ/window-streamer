...
def main():
    ...
    parser.add_argument('--window_id',
                        default=os.environ.get('WINDOW_ID', ''),
                        help='Window id to stream')
    ...
    logger.info("window -- "  + str(window))

    # Create instance of app
    app = GSTWebRTCApp(stun_servers, turn_servers, audio_channels, curr_fps, args.encoder, gpu_id, curr_video_bitrate, curr_audio_bitrate, keyframe_distance, congestion_control, video_packetloss_percent, audio_packetloss_percent, window)
